...
if (!Math) {
  (_easycom_fui_icon + _easycom_fui_nav_bar + TaskProgress + _easycom_up_status_bar + Seed + ImageUploadMore + AudioUpload + ImageUpload + Width + Height + Positive + ModeSelect + Picker + CustomNumberBox + ImageSelectPreview + MoreImageUpload + VideoUpload + _easycom_up_button + TnIcon + DragButton2 + BaseLayout)();
}
...
const VideoUpload = () => "../../../components/dynamic/VideoUpload.js";
...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    common_vendor.index.__f__("log", "at pages/draw/apps/apps.vue:76", "--------------------------", workFlowParamLists);
    ...
    common_vendor.watch(currentSwiperIndex, () => {
      common_vendor.index.__f__("log", "at pages/draw/apps/apps.vue:107", "currentSwiperIndex", currentSwiperIndex.value);
    });
    ...
    function checkFileType(input) {
      ...
      if (!input) {
        common_vendor.index.__f__("log", "at pages/draw/apps/apps.vue:248", "==============", "是空值");
        return 0;
      } else if (imageRegex.test(input)) {
        common_vendor.index.__f__("log", "at pages/draw/apps/apps.vue:253", "==============", "是图片");
        return 1;
      } else if (videoRegex.test(input)) {
        common_vendor.index.__f__("log", "at pages/draw/apps/apps.vue:258", "==============", "是音频");
        return 2;
      }
    }
    common_vendor.ref();
    return (_ctx, _cache) => {
      ...
      return common_vendor.e({
        ...
        g: common_vendor.f(common_vendor.unref(workFlowParamLists), (item, index, i0) => {
          return common_vendor.e({
          ...
          } : common_vendor.unref(handleFindComponentName)(item.name) === "VideoUpload" ? {
            Z: "6cf62e12-17-" + i0 + ",6cf62e12-3",
            aa: common_vendor.o(($event) => common_vendor.unref(bindParam)[item.name] = $event, index),
            ab: common_vendor.p({
              title: item.title,
              modelValue: common_vendor.unref(bindParam)[item.name]
            })
            ...
            Y: common_vendor.unref(handleFindComponentName)(item.name) === "VideoUpload",
            ac: index
          });
        }),
