...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...__default__,
  __name: "lazy-load",
  props: common_vendor.lazyLoadProps$1,
  emits: common_vendor.lazyLoadEmits$1,
  setup(__props) {
    const props = __props;
    const {
      componentId,
    ...
    } = common_vendor.useLazyLoad$1(props);
    const { ns, lazyLoadStyle } = common_vendor.useLazyLoadCustomStyle$1(props);
    return (_ctx, _cache) => {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-8dcbd50d"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../../../../../../.sourcemap/mp-weixin/components/node-modules/@tuniao/tnui-vue3-uniapp/components/lazy-load/src/lazy-load.js.map
