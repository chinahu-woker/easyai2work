...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  __name: "image-upload",
  props: common_vendor.imageUploadProps$1,
  emits: common_vendor.imageUploadEmits$1,
  setup(__props, { expose: __expose }) {
    ...
    const {
      ...
      clearAllFile,
      previewImage
    } = common_vendor.useImageUpload$1(props);
    __expose({
      /**
       * @description 手动选择文件
       */
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-794db985"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../../../../../../.sourcemap/mp-weixin/components/node-modules/@tuniao/tnui-vue3-uniapp/components/image-upload/src/image-upload.js.map
