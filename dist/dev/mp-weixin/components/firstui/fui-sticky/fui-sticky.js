...
const _sfc_main = {
  ...
  methods: {
    ...
    init(callback) {
      ...
      common_vendor.index.createSelectorQuery().in(this).select(elId).fields({
        size: true,
        rect: true
      }, (res) => {
        if (res) {
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/components/firstui/fui-sticky/fui-sticky.js.map
