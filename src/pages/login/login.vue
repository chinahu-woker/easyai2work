<template>
	<fui-background-image src="https://chinahu-ai-server.oss-cn-chengdu.aliyuncs.com/aidraw/image/temps/67873d6c232a3c5d52240dd6/Home2.jpg" class="bg-image"></fui-background-image>
			...
			<view class="wechat-login">
				<fui-button :plain="true" width="200rpx" height="80rpx" background="transparent" borderColor="#E5E7EB"
					...
					<view class="wechat-button">
						<image style="width: 80rpx; height: 80rpx;" src="https://chinahu-ai-server.oss-cn-chengdu.aliyuncs.com/2025-07-08/67873d6c232a3c5d52240dd6/upload/20250708090156694-wxicon.png"></image>
