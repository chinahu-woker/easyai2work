...
function rewriteId(node, context) {
    ...
    if (refProp && !idProp) {
        ...
        if (idProp.exp) {
            const originalId = (0, ast_1.parseExpr)(idProp.exp, context);
            let genId = '';
            if (context.inVFor) {
                // v-for 中的 ref 需要使用 v-for 的 key 作为 id
                const keyAlias = (0, transformSlot_1.parseVForKeyAlias)(context);
            ...
            node.props.push((0, uni_cli_shared_1.createBindDirectiveNode)('id', (0, compiler_core_1.createSimpleExpression)((0, codegen_1.genBabelExpr)((0, types_1.conditionalExpression)((0, types_1.binaryExpression)('!==', originalId, (0, types_1.stringLiteral)('')), originalId, (0, types_1.stringLiteral)(genId))))));
        }
    }
