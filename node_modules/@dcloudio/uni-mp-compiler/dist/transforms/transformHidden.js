...
function rewriteHidden(index, hiddenBindingProp, props, virtualHost, context) {
    ...
    if (virtualHost) {
        ...
        if (expr || staticClassPropIndex > -1) {
            ...
            hiddenBindingExpr = (0, types_1.conditionalExpression)((0, types_1.binaryExpression)('!==', (0, types_1.identifier)(uni_shared_1.VIRTUAL_HOST_HIDDEN), (0, types_1.stringLiteral)('')), (0, types_1.identifier)(uni_shared_1.VIRTUAL_HOST_HIDDEN), res);
        }
        else {
            hiddenBindingExpr = (0, types_1.identifier)(uni_shared_1.VIRTUAL_HOST_HIDDEN);
        }
    }
    else {
