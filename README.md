...
4. **部署注意事项**
   ...
   - 如果遇到微信小程序开发工具中能够正常显示，但是预览或者真机调试没有显示的话很有可能是你的SSL证书微信不认可，需要配置阿里云、腾讯云等大厂的正规SSL证书。（有免费试用）
...
## 💸 赞助支持
如果有特殊需求也可以联系作者定制
如果你觉得这个项目帮到你了，欢迎请作者喝咖如果有特殊需求也可以联系作者定制